...
export default class UserKoFiPaymentsRoute extends RestrictedUserRoute {
  ...
  titleToken() {
    ...
    let title = `${i18n("discourse_kofi.title")} ${i18n("discourse_kofi.user.navigation.payments")}`;
